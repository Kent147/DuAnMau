...
public class NhanVienJFrame extends javax.swing.JFrame {
    ...
    void setModel(NhanVien model) {
        txtMaNV.setText((String) model.getMaNV());
        txtHoTen.setText((String) model.getHoTen());
        txtMatKhau.setText((String) model.getMatKhau());
        txtXacNhanMK.setText((String) model.getMatKhau());
    ...
    public boolean checkError(){
        try {
            NhanVien nhanVien = dao.findById(txtMaNV.getText());
            if (txtMaNV.getText().equals("")) {
                DialogHelper.alert(this, "Không để trống Mã Nhân Viên!");
                return false;
            };
            if (txtHoTen.getText().equals(nhanVien)) {
                DialogHelper.alert(this, "Trùng Mã Nhân Viên!");
                return false;
            };
            if (txtMatKhau.getText().length() < 3) {
                DialogHelper.alert(this, "Mật Khẩu ít nhất 3 ký tự trở lên!");
                return false;
            };
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE)
                .addContainerGap())
        );
