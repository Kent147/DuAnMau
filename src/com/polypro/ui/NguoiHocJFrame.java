...
public class NguoiHocJFrame extends javax.swing.JFrame {
    ...
    void insert() {
        ...
        try {
            ...
            if (e.getErrorCode() == 2627) {
                DialogHelper.alert(this, "Đã có mã người học này!");
            }else{
    ...
    void setModel(NguoiHoc model) {
        txtMaNH.setText((String) model.getMaNH());
        txtHoTen.setText((String) model.getHoTen());
        cboGioiTinh.setSelectedIndex(model.getGioiTinh() ? 0 : 1);
        txtNgaySinh.setText(DateHelper.toString(model.getNgaySinh()));
        txtDienThoai.setText((String) model.getDienThoai());
        txtEmail.setText((String) model.getEmail());
    ...
    void setStatus(boolean insertable) {
        ...
        btnNext.setEnabled(!insertable && first);
        btnLast.setEnabled(!insertable && last);
        btnPre.setEnabled(!insertable && last);
    }
    
    public boolean checkError(){
        try {
            if (txtMaNH.getText().length() < 7 || txtMaNH.getText().length() >8) {
                DialogHelper.alert(this, "Mã Người Học phải đúng 7 kỹ tự!");
    ...
    void search(){
        ...
        try {
            ...
            DialogHelper.alert(this, "Lỗi truy vấn dữ liêu!");
        }
    }
    /**
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(cboGioiTinh, javax.swing.GroupLayout.Alignment.LEADING, 0, 181, Short.MAX_VALUE)
        ...
        tblGridView.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ NH", "HỌ VÀ TÊN", "GIỚI TÍNH", "NGẦY SINH", "ĐIỆN THOẠI", "EMAIL", "MÃ NV", "NGÀY ĐK"
            }
        ) {
