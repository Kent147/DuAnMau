...
public class KhoaHocDAO {
    ...
    public void insert(KhoaHoc model) throws SQLException {
...
JdbcHelper.executeUpdate(sql,
    ...
    public void update(KhoaHoc model) throws SQLException {
...
JdbcHelper.executeUpdate(sql,
    ...
    public void delete(Integer MaKH) throws SQLException {
